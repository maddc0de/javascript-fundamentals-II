...
<!-- HTTP Protocols - is how clients and servers communicate to each other through the network.
HTTP Requests - is what the client sends to the server
HTTP Response - is what the server sends back to the client. -->
